places = {
    'georgia': ['Тбилиси', 'Батуми', 'Рустави', 'Кутаиси', 'Сухуми', 'Гори', 'Поти', 'Зугдиди'],
    'israel': ['Иерусалим', 'Тель-Авив', 'Ашкелон', 'Тверия', 'Цфат', 'Хайфа', 'Ришон-ле-Цион', 'Петах-Тиква', 'Ашдод', 'Нетания', 'Беэр-Шева'],
    'kazakhstan': ['Алма-Ата', 'Астана', 'Шымкент', 'Актобе', 'Караганда', 'Тараз', 'Атырау', 'Павлодар'],
    'turkey': ['Стамбул', 'Анкара', 'Измир', 'Бурса', 'Алания', 'Каш', 'Конья', 'Анталья'],
    'indonesia': ['Бали', 'Джакарта', 'Сурабая', 'Бандунг', 'Бекаси', 'Медан', 'Тангеранг', 'Депок', 'Семаранг'],
    'armenia': ['Ереван', 'Гюмри', 'Иджеван', 'Дилижан', 'Алаверди', 'Джермук', 'Агарак'],
    'thai': ['Паттая', 'Самуи', 'Панган', 'Бангкок', 'Нонтхабури', 'Хатъяй', 'Сураттхани', 'Удонтхани', 'Накхонратчасима', 'Чиангмай', 'Кхонкэн']
}
